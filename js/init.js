$(function () {
    $(".form-container").append('<script id="myFormDesign" type="text/plain" style="width:100%;"></script>');
    ...
    function fixPageSize() {
        ...
        $('.edui-default .edui-editor-iframeholder').css('height',total-21-$('.edui-default .edui-editor-toolbarbox').height());
    }
